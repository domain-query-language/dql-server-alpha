...
namespace Infrastructure\App\Service\DQLParser;

/* Usefull functions: */

/* chr_unicode - get unicode character from its char code */
if (!function_exists('Infrastructure\\App\\Service\\DQLParser\\chr_unicode')) { function chr_unicode($code) { return mb_convert_encoding('&#' . $code . ';', 'UTF-8', 'HTML-ENTITIES');} }
/* peg_regex_test - multibyte regex test */
if (!function_exists('Infrastructure\\App\\Service\\DQLParser\\peg_regex_test')) { function peg_regex_test($pattern, $string) { if (substr($pattern, -1) == 'i') return mb_eregi(substr($pattern, 1, -2), $string); else return mb_ereg(substr($pattern, 1, -1), $string);}}
...
class PHPPegJSParser{
  ...
  public function parse($input) {
    ...
    $this->peg_c13 = array();
    $this->peg_c14 = "/^[A-Za-z0-9_-]/";
    $this->peg_c15 = array( "type" => "class", "value" => "[A-Za-z0-9_\\-]", "description" => "[A-Za-z0-9_\\-]" );
